/datum/language/highimperial
	...
	desc = "The language of the Imperial Nobility. Borrowing some elements from the original inhabitants of the Imperial homeworld, the language is distinctly more structured."
	speech_verb = "yips"
	ask_verb = "mrowls"
	exclaim_verb = "wails"
	colour = "akhani"
