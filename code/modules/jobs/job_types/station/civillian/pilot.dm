/datum/role/job/station/pilot
	...
	desc = "A Pilot flies the various shuttles attached to the ship.\
...
/datum/prototype/struct/alt_title/co_pilot
	title = "Imperial Navy Junior Pilot"
...
/datum/outfit/job/station/pilot
	name = OUTFIT_JOB_NAME("Imperial Navy Pilot")
	...
	id_pda_assignment = "Imperial Navy Pilot"
