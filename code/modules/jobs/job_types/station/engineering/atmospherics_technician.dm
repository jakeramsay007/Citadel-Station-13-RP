/datum/role/job/station/atmos
	...
	title = "IEC Atmospheric Technician"
	flag = ATMOSTECH
	...
	desc = "An Atmospheric Technician is primarily concerned with keeping the ship's atmosphere breathable. They are expected to have a good \
						understanding of the pipes, vents, and scrubbers that move gasses around the ship, and to be familiar with proper firefighting procedure. \
						Atmospheric Technicians typically hold the rank of Sergeant or Staff Sergeant, on account of being expected to be senior Engineers."
...
/datum/prototype/struct/alt_title/life_support
	title = "IEC Life Support Technician"
...
/datum/prototype/struct/alt_title/pipe_spec
	title = "IEC Pipe Network Specialist"
...
/datum/prototype/struct/alt_title/disposals_tech
	title = "IEC Disposals Technician"
...
/datum/outfit/job/station/atmospherics_technician
	name = OUTFIT_JOB_NAME("IEC Atmospheric technician")
