...
/datum/role/job/station/captain
	...
	desc = "The Captain manages the other Command Staff, and through them the rest of the ship. Though they have access to everything, \
						...
						They typically hold the rank of Captain."
